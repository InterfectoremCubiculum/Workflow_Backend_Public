...
namespace WorkflowTime.Migrations
{
    ...
    [Migration("20250630223123_Letter_Cap_Changed")]
    partial class Letter_Cap_Changed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkflowTime.Features.UserManagment.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("WorkflowTime.Features.WorkingDayStateManagement.Models.WorkingDaysState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorkingDaysStates");
                });

            modelBuilder.Entity("WorkflowTime.Features.DayOffs.Models.DayOffRequest", b =>
                {
                    b.HasOne("WorkflowTime.Features.UserManagment.Models.User", "User")
                        .WithMany()
